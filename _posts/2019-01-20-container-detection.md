...
&ensp;&ensp;&ensp;&ensp;另外，由于个人原因离开原公司也有一段时间了，这段时间很闲，除了继续学coursera的视频外，心里一直也有一个结没有打开，我总觉得即使以当时的能力和数据集大小，最后产品实现的OCR准确性应该还是有可能再高一点的，因为后面产品化开发的时候，我就恢复“本色”了：动嘴不动手。所以，决定动手把自己的疑惑尝试一下看看感觉是否方向正确。最后，发张检测效果图。
